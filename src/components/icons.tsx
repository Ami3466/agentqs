...
/** Slack's official four-colour hash (slack.com brand asset, 127-grid). Flattened
 *  to one fill it reads as a smudge at 15px — the colours ARE the logo, so this
 *  one mark keeps them and ignores currentColor. */
export const Slack = (p: P) => (
  <svg {...base} viewBox="0 0 127 127" fill="none" stroke="none" {...p}>
    <path
...
export const Safari = (p: P) => (
  <svg {...base} fill="none" stroke="currentColor" strokeWidth={1.6} {...p}>
    <circle cx="12" cy="12" r="9.2" />
    {/* compass needle */}
    <path d="M15.8 8.2l-2.6 5-5 2.6 2.6-5z" fill="currentColor" stroke="none" />
  </svg>
);
...
/** Granola's real brand mark — the swirl app icon, geometry traced from the
 *  official granola.ai logo SVG and scaled to the 24px grid. */
export const Granola = (p: P) => (
  <svg {...base} fill="currentColor" stroke="none" {...p}>
    <path d="M20.1 19.6C19.6 20.1 19.2 20.4 19 20.6 18.9 20.7 18.8 20.8 18.7 20.9 18.2 21.3 17.7 21.4 17.4 21.7 16.9 22.1 15 22.6 14.4 22.7 13.6 22.9 12.5 23 11.4 23 11.2 23 11 23 10.8 22.9 10.7 22.9 10.6 23 10.5 23 10.5 23 10.5 23 10.5 23 10.5 23 10.5 22.9 10.5 22.9 10.4 22.9 10.4 22.9 10.4 22.9 10.4 22.9 10.4 22.9 10.4 22.9 10.3 22.9 10.2 22.9 10.2 23 10.1 23 10.1 23 10.1 22.9 9.9 22.9 9.7 22.7 9.7 22.7 9.6 22.7 9.6 22.7 9.5 22.7 9.5 22.7 9.5 22.7 9.5 22.7 9.4 22.7 9.4 22.7 9.4 22.6 9.3 22.6 9.2 22.7 9.1 22.6 9.1 22.6 9 22.5 9 22.5 9 22.5 9 22.5 9 22.5 8.8 22.5 8.6 22.4 8.4 22.4 8.2 22.3 8.3 22.3 8.2 22.2 6.9 21.8 5.2 20.9 4.5 20.2 4.3 20 4 19.4 3.8 19.3 3.7 19.2 3.4 18.9 3.4 18.8 3.3 18.7 3.4 18.6 3.3 18.4 3.1 18.3 2.9 18.2 2.7 17.9 2.4 17.4 2.3 16.9 2 16.4 1.8 15.9 1.2 14.4 1.2 11.7 1.2 9.8 2.1 7.3 2.5 6.9 2.7 6.7 2.7 6.2 2.9 6 4.8 3.2 8.2 1.2 12.3 1 12.5 1 12.6 1 12.8 1 13.8 1 14.8 1.1 15.8 1.4 16.8 1.6 17.7 2 18.6 2.4 18.6 2.4 18.7 2.4 18.7 2.4 18.8 2.4 18.8 2.5 18.9 2.5 18.9 2.5 19 2.5 19 2.5 19.2 2.5 19.2 2.6 19.3 2.7 19.3 2.7 19.3 2.8 19.4 2.8 19.6 2.8 19.7 2.9 19.7 3 19.7 3 19.7 3 19.8 3 19.8 3.1 19.8 3.1 19.8 3.1 19.9 3.1 20 3.2 20 3.4 20 3.4 20.1 3.5 20.1 3.6 20.1 3.7 20.1 3.7 19.9 4S19 4.5 18.6 4.3C17.4 3.9 17.3 3.8 16.8 3.6 15.8 3.4 15.1 3.2 14.2 3.2 12.7 3.3 11.5 3.4 10.1 3.9 9.5 4.1 8.3 4.7 7.7 5.2 7.1 5.6 6.3 6.3 5.9 6.9 5.8 7.1 5.7 7.3 5.4 7.6 5 8.1 4.5 9.4 4.3 10 4.3 10.2 4.4 10.3 4.3 10.5 4.3 10.6 4 10.7 4 10.8 3.9 11.3 3.9 11.8 3.9 12.3 3.9 12.6 4 13 4.1 13.