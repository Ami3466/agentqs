...
/** Slack's four-lozenge hash, flattened to a single `currentColor` fill so it
 *  matches the other monochrome source marks. */
export const Slack = (p: P) => (
  <svg {...base} viewBox="0 0 127 127" fill="currentColor" stroke="none" {...p}>
